...
Данная лабораторная работа предполагает реализацию функций класса-шаблона `Sample` для двумерной выборки. 

Сначала необходимо создать класс без использования шаблона, а затем переделать его в шаблонный класс.
