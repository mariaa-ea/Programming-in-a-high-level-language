...
// 2. Перейти: Средства -> Диспетчер пакетов NuGet -> Управление пакетами NuGet для решения… 
// 3. Найти и установить нужную библиотеку, добавив ее в проект
// 4. Включить библиотеку в проект 
// 5. Проверить подключение (см. ниже)
// 
//       СПОСОБ #2
// 
// Воспользоваться менеджером пакетов/зависимостей vcpkg: https://vcpkg.io/en/ 
//		-> Скачать
//		-> В командной строке проекта выполнить: vcpkg install <имя_библиотеки> 
//		-> Включить в проект
//		-> Проверить подключение (см. ниже)
//
// ----------------------------------
// 
...
//  ----------------------------------
//
// ДЛЯ ПРОВЕРКИ ПОДКЛЮЧЕНИЯ БИБЛИОТЕКИ <fftw3.h> запустить код ниже:
// 
//#include <iostream>
//#include <fftw3.h>
//
//int main() {
//	const char* version = fftw_version();
//	std::cout << "FFTW version: " << version << std::endl;
//	return 0;
//}
// ----------------------------------
// 
//       СПОСОБ #3
// 
// В ПРОЕКТ ВСТАВИТЬ ПУТЬ БИБЛИОТЕК, ДЛЯ ЭТОГО:
// 1. Скачать библиотеки: https://www.boost.org/, https://www.fftw.org/install/windows.html
// 2. КЛИКНУТЬ В ПОЛЕ ПРОЕКТА
// 3. ПЕРЕЙТИ В "СВОЙСТВА"
// 4. ВЫБРАТЬ КАТАЛОГИ VS
// 5. ВСТАВИТЬ ПУТЬ БИБЛИОТЕКИ C:\Program Files\boost_1_84_0;C:\Program Files\fftw-3.3.5-dll64; В ПОЛЯ 
// - "Каталоги включения" и "Каталоги библиотек"
// 6. Перейти в cd PS C:\Program Files\fftw-3.3.5-dll64>
// 7. Ввести в PowerShell: lib /machine:x64 /def:libfftw3-3.def
...
// ----------------------------------
// 
// В случае, если возникли сложности:
// ---> Следовать инструкции: https://russianblogs.com/article/3339529859/ 
// 
// ----------------------------------
