...
// - Или воспользоваться менеджером пакетов/зависимостей vcpkg: https://vcpkg.io/en/ 
//		-> Скачать
//		-> В командной строке проекта выполнить: vcpkg install fftw3
//		-> Включить в проект
//		-> Проверить подключение (см. выше)
// 
// ----------------------------------
